...
class Bean_Flickr_Widget extends WP_Widget 
{
	...
	public function __construct() 
	{
		parent::__construct(
	 		'bean_flickr', // BASE ID
			'Flickr Photos', // NAME
			array( 'description' => __( 'Add a Flickr feed widget.', 'bean' ), )
		);
	}
	...
	function widget( $args, $instance ) 
	{
		...
		<div class="flickr-image-wrapper">
			...
			<script type="text/javascript" src="http://www.flickr.com/badge_code_v2.gne?count=10&amp;display=<?php echo $display ?>&amp;size=s&amp;layout=x&amp;source=<?php echo $type ?>&amp;<?php echo $type ?>=<?php echo $flickrID ?>"></script>
